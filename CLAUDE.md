...
> Guidance for Claude Code working in this repo. Read this first, then open the
> linked docs in `.claude/docs/` only when a task touches that area.
...
capture (Qualisys/Vicon); see [roadmap](.claude/docs/roadmap.md).
...
[orphaned_code.md](.claude/docs/orphaned_code.md). Trust the code over the older
root `.md` files.
...
[performance_and_hardware.md](.claude/docs/performance_and_hardware.md).
...
|-----------|---------------|
| [.claude/docs/pipeline.md](.claude/docs/pipeline.md) | Touching upload→process→playback flow, the dual pose engine, or frame timing |
| [.claude/docs/data_contract.md](.claude/docs/data_contract.md) | Changing the analysis JSON, keypoint names, or anything crossing backend↔frontend |
| [.claude/docs/architectural_patterns.md](.claude/docs/architectural_patterns.md) | Adding a module and want to match existing conventions |
| [.claude/docs/orphaned_code.md](.claude/docs/orphaned_code.md) | About to edit/delete a CV/analytics module, or asked "why isn't X working" |
| [.claude/docs/performance_and_hardware.md](.claude/docs/performance_and_hardware.md) | Anything about speed, CPU/GPU, model size, resolution, frame skipping |
| [.claude/docs/roadmap.md](.claude/docs/roadmap.md) | Discussing multi-camera, 3D triangulation, sensor fusion, or future direction |
